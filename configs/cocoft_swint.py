...
model = dict(
    type='DINO_R1',
    visual_prompt_encoder_cfg=dict(
    ...
    bbox_head=dict(
        type='DINO_R1_Head',
        num_classes=train_num_classes, # 256,
...
train_pipeline = [
    ...
    dict(
        type='RandomSamplingNegPos_Ours',
...
coco_od_dataset = dict(
    type=dataset_type,
    data_root=data_root,
    ann_file='annotations/instances_train2017_norefval_od.json',
...
train_cfg = dict( type='EpochBasedTrainLoop_DINO_R1', max_epochs=max_epochs, val_interval=1)
...
runner_type = "Runner_DINO_R1"

find_unused_parameters = False
model_wrapper_cfg = dict(type='MMDistributedDataParallel_DINO_R1', broadcast_buffers=False, find_unused_parameters=find_unused_parameters)
